$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Taylor and McKayla's Wedding Reception",
            ...
            // Event Address
            address: '439 N 2100 E, St. Anthony ID',

            // Event Description
            // description: "We can't wait to see you on our big day. For any questions or issues, please contact ******* at 555-555-5555."
        }
    });
    ...
    $('#address-form').on('submit', function (e) {
        ...
        // if (MD5($('#invite_code_addr').val()) === '2248724b0c019e48ad99a6791e8213b9') { // sealing
            
                $.post('https://script.google.com/macros/s/AKfycbwR6r-KNp-JvIQfzCCXOAr3-vQ3KUgsCe8xkaLmcnwTx9h0D84jIY-ZdjsbMsA9frUHgg/exec', data)
                    .done(function (data) {
                        console.log(data);
                        if (data.result === "error") {
                            $('#alert-wrapper').html(alert_markup('danger', data.message));
...
// Google map
function initMap() {
    var location = { lat: 43.9475512, lng: -111.7403864 };
...
//     var la_fiesta = { lat: -33.860664, lng: 151.208138 };
//     var map = new google.maps.Map(document.getElementById('map-canvas'), {
//         zoom: 15,
//         center: la_fiesta,
//         scrollwheel: false
